...
public:
    union
    {
        DEFINE_MEMBER_N(bool IsChatOpen, 0x570);
    };
};
...
public:
    union
    {
        DEFINE_MEMBER_N(float MoveSpeed, 0x228);
        DEFINE_MEMBER_N(bool IsMoving, 0x22C);
        DEFINE_MEMBER_N(Vector3 StartPos, 0x240);
        DEFINE_MEMBER_N(Vector3 EndPos, 0x24C);
        DEFINE_MEMBER_N(Vector3 *TargetPaths, 0x258);
        DEFINE_MEMBER_N(_DWORD SegmentCount, 0x260);
        DEFINE_MEMBER_N(bool DashSpeed, 0x270);
        DEFINE_MEMBER_N(bool Dash, 0x294);
        DEFINE_MEMBER_N(Vector3 Velocity, 0x390);
    };
...
public:
    union
    {
        ...
        DEFINE_MEMBER_N(OInventory *Inventory, 0x2338);
        DEFINE_MEMBER_N(OBuffManager BuffManager, 0x24D8);
        DEFINE_MEMBER_N(OSpellBook SpellBook, 0x2730);
        DEFINE_MEMBER_N(OActiveSpell *ActiveSpell, 0x2768);
        DEFINE_MEMBER_N(uint8_t Level, 0x3FF8);
    };
