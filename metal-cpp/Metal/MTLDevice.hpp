...
public:
    ...
    class CommandQueue*             makeCommandQueue();
...
// method: makeCommandQueue
_MTL_INLINE MTL::CommandQueue* MTL::Device::makeCommandQueue()
{
    return Object::sendMessage<MTL::CommandQueue*>(this, _MTL_PRIVATE_SEL(makeCommandQueue));
}
